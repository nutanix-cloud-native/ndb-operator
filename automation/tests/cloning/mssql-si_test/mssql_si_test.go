...
// MSSQLCloningSingleInstanceTestSuite is a test suite struct that embeds testify's suite.Suite
type MSSQLCloningSingleInstanceTestSuite struct {
	suite.Suite
	ctx               context.Context
...
func (suite *MSSQLCloningSingleInstanceTestSuite) SetupSuite() {
	var err error
...
func (suite *MSSQLCloningSingleInstanceTestSuite) TearDownSuite() {
	var err error
...
func (suite *MSSQLCloningSingleInstanceTestSuite) BeforeTest(suiteName, testName string) {
...
func (suite *MSSQLCloningSingleInstanceTestSuite) AfterTest(suiteName, testName string) {
...
func TestMSSQLCloningSingleInstanceTestSuite(t *testing.T) {
	suite.Run(t, new(MSSQLCloningSingleInstanceTestSuite))
}
