...
type RequestAppender interface {
	...
	appendProvisioningRequest(req *DatabaseProvisionRequest, database DatabaseInterface, reqData map[string]interface{}) *DatabaseProvisionRequest
	// Function to add additional arguments to the Cloning request
	appendCloningRequest(req *DatabaseCloneRequest, database DatabaseInterface, reqData map[string]interface{}) *DatabaseCloneRequest
}
